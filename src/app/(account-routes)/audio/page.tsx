...
const AudioSettings = () => {
    ...
    return (
        <Account>
            <div className="bg h-[750px] rounded-[18px] bg-[#FFFFFF] pb-[24px]">
                ...
                <div className="flex items-center gap-x-[24px] px-[24px] pb-[24px]">
                    <button
                        className={`rounded-[59px] px-[32px] py-[10px] ${isChanged
            ...
            <div className="shadow-md mt-[48px] rounded-[18px] bg-white pb-[24px]">
