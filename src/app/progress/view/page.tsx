    ...
    <div className="w-full">
      ...
      <div className="flex w-full items-center justify-center bg-[#F9FAFA] px-[80px] py-[65px]">
        <div className="flex w-full flex-col gap-[48px]">
          ...
          <div className="flex flex-col gap-[24px] py-[65px]">
            ...
            <div className="flex w-full flex-row gap-[24px]">
              <div className="flex w-1/3 flex-col gap-[28px] rounded-[16px] border-[1px] border-neutral-60 bg-neutral-20 p-[24px]">
            ...
            <div className="flex flex-col gap-[16px] rounded-[12px] border-[1px] border-[#C7D3E1] px-[48px] py-[24px]">
              <div className="h-[53px] border-b-[1px] border-b-[#C7D3E1] font-axiforma text-[24px] font-bold">
                New Words Learnt
              </div>
              <div className="flex w-full flex-col gap-[48px] rounded-[10px] bg-transparent-white-35 px-[32px] py-[24px]">
                {category.words.map((word, index: number) => (
                  ...
                  >
                    <div
                      className={`w-[40px] text-[${category.newWords.includes(word.local) ? newWordsColor : wordsColor}]`}
                    >
                      {word.local}
                    </div>
                    <div className="h-[3px] w-[200px] bg-transparent-black-50"></div>
                    <div
                      className={`w-[80px] text-[${category.newWords.includes(word.local) ? newWordsColor : wordsColor}]`}
                    >
                      {word.interpretation}
                    </div>
                    <div>
