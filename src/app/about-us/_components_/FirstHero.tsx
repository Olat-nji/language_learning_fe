...
const FirstHero = () => {
  return (
    <header className="flex w-full gap-[10px] bg-secondary-120 p-[12px] lg:p-[40px]">
      <div className="flex w-full max-w-[1654px] flex-col gap-[48px] border-transparent-white-15 bg-white py-[12px] md:pb-[48px] lg:gap-[64px] lg:border-[8px] lg:border-solid">
