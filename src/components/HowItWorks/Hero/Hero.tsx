...
const HeroSection = () => {
    return (
        ...
        //     <LightNav />
        // </div>
        <section className="bg-white border-4 lg:border-[40px] border-secondary-120 p-4 lg:p-10 ">

        {/* <LightNav /> */}

                <h1 className="text-[32px] lg:text-[64px] text-center leading-[12px] lg:leading-[96px] text-secondary-120 font-bold my-16 lg:my-16">How It Works</h1>
