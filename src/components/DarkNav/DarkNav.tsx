...
const DarkNav = () => {
  ...
  return (
    <>
      <nav className="fixed max-w-[1728px] mx-auto left-0 right-0 top-0 z-50 w-screen px-0">
        {isSignedIn ? (
        <div className={`w-full px-20 py-6 mx-auto hidden flex-row items-center bg-white shadow-md md:flex md:justify-between md:shadow  ${styles.navLinkGradient}`}>
                <Logo />
                <>
        ...
        <div className="w-5/5 py-6 px-20 mx-auto hidden flex-row items-center shadow-md md:flex md:justify-between md:shadow md:ring-primary-20 ">
          <Logo />
        ...
        >
          ...
          <div className="flex items-center space-x-4">
            {isSignedIn ? (
              <div className="flex gap-4 h-full w-full bg-white p-1">
                <Image
                  src="/navbar/profile-standin.svg"
                  alt="profile-icon"
                  width={48}
              ...
              <>
                ...
                <button
                  onClick={toggleSidebar}
                  className="bg-white p-[10px] w-10 h-10 rounded-[59px] border border-neutral-40"
                >
                  <Image
