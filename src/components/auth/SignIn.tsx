...
const SignIn = () => {
  return (
    <>
      <div className="min-w-[300px] overflow-hidden rounded-[20px] bg-neutral-10 font-abel shadow-md lg:min-w-[500px]">
        <div className="flex flex-col items-center gap-[10px] bg-white py-[20px]">
          <h1 className="text-[40px] font-bold text-secondary-110">Sign In</h1>
        ...
        <div className="flex h-[100px] items-center justify-center bg-neutral-10">
          <div className="flex flex-row gap-[20px]">
            ...
            <CustomButton variant="secondary" size="icon">
              <Image src={linkIcon} alt="profile-icon" width={18} height={22} />
            </CustomButton>
          </div>
        </div>
        <div className="flex flex-col gap-[5px]">
          ...
          <div className="bg-white">
            ...
            <div className="flex flex-row items-center justify-between bg-white p-[30px] pt-0">
              <div className="flex flex-row gap-[20px]">
                ...
                <p className="text-[14px] text-neutral-130">Remember me</p>
              </div>
          ...
          <div className="flex flex-col items-center gap-[20px] bg-white p-[20px]">
            ...
            <p className="">
              ...
              <a href="/signup" className="text-[12px] text-primary-100">
                Sign Up
              </a>
            </p>
          </div>
