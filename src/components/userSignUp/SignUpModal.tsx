...
const SignUpModal: React.FC<SignUpModalProperties> = ({ closeModal }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = () => {
    ...
    closeModal(); // Call closeModal when form is submitted
  };

  return (
    <div className="fixed inset-0 flex h-screen items-center justify-center bg-gray-900 bg-opacity-50">
      <div className="shadow-lg w-96 rounded-[16px] bg-white p-6 lg:w-[600px]">
