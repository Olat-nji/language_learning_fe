...
class TalkingHead {
  ...
  constructor(node, opt = null) {
    ...
    this.opt = {
      ...
      lightAmbientColor: 0xff_ff_ff,
      lightAmbientIntensity: 2,
      lightDirectColor: 0x88_88_aa,
      lightDirectIntensity: 30,
      lightDirectPhi: 1,
      lightDirectTheta: 2,
      lightSpotIntensity: 0,
      lightSpotColor: 0x33_88_ff,
      lightSpotPhi: 0.1,
      lightSpotTheta: 4,
    ...
    if (this.opt.statsNode) {
      ...
      this.opt.statsNode.append(this.stats.dom);
    }
    ...
    for (const x of Object.values(this.poseTemplates)) {
    ...
    for (const x of ["Left", "Right"]) {
      for (const y of ["Leg", "UpLeg", "Arm", "ForeArm", "Hand"]) {
    ...
    const names = new Set();
    for (const x of Object.values(this.poseTemplates)) {
      for (const y of Object.keys(x.props)) names.add(y);
    }
    for (const x of Object.keys(this.poseDelta.props)) {
      names.add(x);
    }
    ...
    this.animMoods = {
      "neutral": {
        ...
        anims: [
          ...
          },
          {
            name: "pose",
            alt: [
              { p: 0.4, delay: [5000, 20_000], vs: { pose: ["side"] } },
              {
                p: 0.4,
                delay: [5000, 20_000],
                vs: { pose: ["hip"] },
                "M": { delay: [5000, 20_000], vs: { pose: ["wide"] } },
              },
              { delay: [5000, 20_000], vs: { pose: ["straight"] } },
            ],
          },
          {
            name: "head",
      ...
      "happy": {
        ...
        anims: [
          ...
          },
          {
            ...
            idle: {
              alt: [
                { p: 0.6, delay: [5000, 20_000], vs: { pose: ["side"] } },
                {
                  p: 0.2,
                  delay: [5000, 20_000],
                  vs: { pose: ["hip"] },
                  "M": { delay: [5000, 20_000], vs: { pose: ["side"] } },
                },
                { p: 0.1, delay: [5000, 20_000], vs: { pose: ["straight"] } },
                { delay: [5000, 10_000], vs: { pose: ["wide"] } },
            ...
            talking: {
              alt: [
                { p: 0.4, delay: [5000, 20_000], vs: { pose: ["side"] } },
                { p: 0.4, delay: [5000, 20_000], vs: { pose: ["straight"] } },
                {
                  delay: [5000, 20_000],
                  vs: { pose: ["hip"] },
                  "M": { delay: [5000, 20_000], vs: { pose: ["wide"] } },
          ...
          },
          {
            ...
            alt: [
              ...
              { p: 0.4, delay: [5000, 20_000], vs: { pose: ["straight"] } },
              {
                delay: [5000, 10_000],
                vs: { pose: ["side"] },
                full: { delay: [5000, 10_000], vs: { pose: ["oneknee"] } },
              },
            ],
          },
          {
      ...
      "fear": {
        ...
        anims: [
          ...
          },
          {
            name: "pose",
            alt: [
              { p: 0.8, delay: [5000, 20_000], vs: { pose: ["side"] } },
              { delay: [5000, 20_000], vs: { pose: ["straight"] } },
              { delay: [5000, 10_000], vs: { pose: ["wide"] } },
              {
                delay: [5000, 10_000],
      ...
      "disgust": {
        ...
        anims: [
          ...
          {
            name: "pose",
            alt: [{ delay: [5000, 10_000], vs: { pose: ["side"] } }],
          },
          {
            name: "head",
            idle: {
      ...
      "love": {
        ...
        anims: [
          ...
          },
          {
            ...
            alt: [
              { p: 0.4, delay: [5000, 20_000], vs: { pose: ["side"] } },
              { p: 0.2, delay: [5000, 20_000], vs: { pose: ["straight"] } },
              {
                p: 0.2,
                delay: [5000, 20_000],
                vs: { pose: ["hip"] },
              ...
              },
              {
                delay: [5000, 10_000],
                vs: { pose: ["side"] },
                full: { delay: [5000, 10_000], vs: { pose: ["kneel"] } },
              },
              {
                delay: [1000, 3000],
                vs: { pose: ["turn"] },
              ...
              },
              {
                ...
                vs: { pose: ["side"] },
                "M": { delay: [5000, 20_000], vs: { pose: ["side"] } },
                full: { delay: [5000, 20_000], vs: { pose: ["bend"] } },
              },
              {
                delay: [1000, 3000],
                vs: { pose: ["side"] },
      ...
      "sleep": {
        ...
        anims: [
          ...
          {
            name: "pose",
            alt: [{ delay: [5000, 20_000], vs: { pose: ["side"] } }],
          },
          {
            name: "head",
            delay: [1000, 5000],
          ...
          { name: "eyes", delay: 10_010, dt: [], vs: {} },
          { name: "blink", delay: 10_020, dt: [], vs: {} },
          { name: "mouth", delay: 10_030, dt: [], vs: {} },
          { name: "misc", delay: 10_040, dt: [], vs: {} },
        ],
      },
    };
    ...
    for (let index = 0; index < b64Chars.length; index++)
      this.b64Lookup[b64Chars.charCodeAt(index)] = index;
    ...
    this.nodeAvatar.append(this.renderer.domElement);
    ...
    const ikBones = [];
    for (const [index, e] of Object.entries(ikSetup).entries()) {
  ...
  b64ToArrayBuffer(chunk) {
    ...
    let bufLength = (3 * chunk.length) / 4;
    if (chunk.at(-1) === "=") {
      bufLength--;
      if (chunk.at(-2) === "=") {
        bufLength--;
    ...
    const arrayBuf = new ArrayBuffer(bufLength);
    ...
    // Populate the buffer
    for (index = 0; index < chunk.length; index += 4) {
      c1 = this.b64Lookup[chunk.charCodeAt(index)];
      c2 = this.b64Lookup[chunk.charCodeAt(index + 1)];
      c3 = this.b64Lookup[chunk.charCodeAt(index + 2)];
      c4 = this.b64Lookup[chunk.charCodeAt(index + 3)];
      array[p++] = (c1 << 2) | (c2 >> 4);
      array[p++] = ((c2 & 15) << 4) | (c3 >> 2);
      array[p++] = ((c3 & 3) << 6) | (c4 & 63);
    }
  ...
  concatArrayBuffers(bufs) {
    let length_ = 0;
    for (const buf_ of bufs) {
      length_ += buf_.byteLength;
    }
    let buf = new ArrayBuffer(length_);
    let array = new Uint8Array(buf);
    let p = 0;
    for (const buf_ of bufs) {
      array.set(new Uint8Array(buf_), p);
      p += buf_.byteLength;
    }
    return buf;
  }
  ...
  pcmToAudioBuffer(buf) {
    const array = new Int16Array(buf);
    const floats = new Float32Array(array.length);
    for (const [index, element] of array.entries()) {
      floats[index] =
        element >= 0x80_00
          ? -(0x1_00_00 - element) / 0x80_00
          : element / 0x7f_ff;
    }
  ...
  propsToThreeObjects(p) {
    ...
    for (let [key, value] of Object.entries(p)) {
      ...
      switch (ids[1]) {
        case "position":
        case "scale": {
          v = new THREE.Vector3(value.x, value.y, value.z);
        ...
        case "rotation": {
          ...
          v = new THREE.Quaternion()
            .setFromEuler(new THREE.Euler(value.x, value.y, value.z, "XYZ"))
            .normalize();
  ...
  clearThree(object) {
    while (object.children.length > 0) {
      this.clearThree(object.children[0]);
      object.remove(object.children[0]);
    }
    if (object.geometry) object.geometry.dispose();

    if (object.material) {
      for (const x of Object.keys(object.material)) {
        if (
          object.material[x] &&
          object.material[x] !== null &&
          typeof object.material[x].dispose === "function"
        ) {
          object.material[x].dispose();
        }
      }
   ...
   * @param {Object} avatar Avatar object with 'url' property to GLTF/GLB file.
  ...
  async showAvatar(avatar, onprogress = null) {
    ...
    for (const x of this.posePropNames) required.push(x.split(".")[0]);
    ...
    this.armature.traverse((x) => {
      if (
        ...
        x.morphTargetInfluences.length > 0 &&
    ...
    for (const x of this.posePropNames) {
      const ids = x.split(".");
  ...
  getPoseString(pose, prec = 1000) {
    let s = "{";
    for (const [index, x] of Object.entries(pose).entries()) {
      const ids = x[0].split(".");
      if (
        ids[1] === "position" ||
        ids[1] === "rotation" ||
        ...
        const value = x[1].isQuaternion
          ? new THREE.Euler().setFromQuaternion(x[1])
          : x[1];
        s += (index ? ", " : "") + "'" + key + "':{";
        s += "x:" + Math.round(value.x * prec) / prec;
        s += ", y:" + Math.round(value.y * prec) / prec;
        s += ", z:" + Math.round(value.z * prec) / prec;
        s += "}";
      }
    }
    s += "}";
  ...
  getPoseTemplateProp(key) {
    ...
    if (this.poseWeightOnLeft) {
      ...
      if (key.startsWith("Left")) {
        key = "Right" + key.slice(4);
      } else if (key.startsWith("Right")) {
        key = "Left" + key.slice(5);
      }
      q = this.poseTarget.template.props[key].clone();
      if (q.isQuaternion) {
        q.x *= -1;
  ...
  poseFactory(template, duration) {
    ...
    for (const x of Object.entries(template.props)) {
  ...
  setPoseFromTemplate(template) {
    ...
    for (const key of Object.keys(this.poseDelta.props)) {
  ...
  getValue(mt) {
    switch (mt) {
      ...
      default: {
        if (mt.startsWith("handFist")) {
          const side = mt.slice(8);
          ...
          return ndx === undefined
            ? 0
            : this.morphs[0].morphTargetInfluences[ndx];
        }
      }
    }
  }
  ...
  setMood(s) {
    ...
    for (const x of this.mood.anims) {
      let index = this.animQueue.findIndex((y) => y.template.name === x.name);
      if (index !== -1) {
        this.animQueue.splice(index, 1);
      }
  ...
  animFactory(t, loop = false, scaleTime = 1, scaleValue = 1) {
    ...
    while (1) {
      if (a.hasOwnProperty(this.stateName)) {
        ...
        if (a.alt.length > 1) {
          ...
          let p = 0;
          for (let index = 0; index < a.alt.length; index++) {
            p += a.alt[index].p || (1 - p) / (a.alt.length - index);
            if (coin < p) {
              b = a.alt[index];
              break;
            }
    ...
    if (a.hasOwnProperty("dt")) {
      for (const [index, x] of a.dt.entries()) {
        o.ts[index + 1] =
          o.ts[index] +
    ...
    // Mood
    if (t.hasOwnProperty("mood")) o.mood = [...t.mood];
  ...
  valueAnimationSeq(ts, vs, t, fun = null) {
    let indexMin = 0;
    let indexMax = ts.length - 1;
    if (t <= ts[indexMin])
      return typeof vs[indexMin] === "function" ? vs[indexMin]() : vs[indexMin];
    if (t >= ts[indexMax])
      return typeof vs[indexMax] === "function" ? vs[indexMax]() : vs[indexMax];
    while (t > ts[indexMin + 1]) indexMin++;
    indexMax = indexMin + 1;
    let k =
      ((typeof vs[indexMax] === "function" ? vs[indexMax]() : vs[indexMax]) -
        (typeof vs[indexMin] === "function" ? vs[indexMin]() : vs[indexMin])) /
      (ts[indexMax] - ts[indexMin]);
    if (fun) k = fun((t - ts[indexMin]) / (ts[indexMax] - ts[indexMin])) * k;
    const b =
      (typeof vs[indexMin] === "function" ? vs[indexMin]() : vs[indexMin]) -
      k * ts[indexMin];
    return k * t + b;
  ...
  gaussianRandom(start, end, skew = 1, samples = 5) {
    let r = 0;
    for (let index = 0; index < samples; index++) r += Math.random();
  ...
  animate(t) {
    ...
    // Animations
    for (let index = 0; index < this.animQueue.length; index++) {
      const x = this.animQueue[index];
      if (this.animClock >= x.ts[0]) {
        for (let [mt, vs] of Object.entries(x.vs)) {
          switch (mt) {
            ...
            case "handLeft":
            case "handRight": {
              for (let index_ = 0; index_ < x.ts.length; index_++) {
                if (vs[index_] && this.animClock >= x.ts[index_]) {
                  o[mt] = Object.assign(o[mt] || {}, vs[index_]);
                  vs[index_] = null;
                }
              }
            ...
            default: {
              ...
              for (let index_ = 0; index_ < index; index_++) {
                if (this.animQueue[index_].vs.hasOwnProperty(mt))
                  delete this.animQueue[index_].vs[mt];
              }
            }
          }
        }
        if (this.animClock >= x.ts.at(-1)) {
          ...
          if (x.loop) {
            let restrain =
              ...
              (x.template.name === "head" || x.template.name === "eyes")
                ? 4
                : 1;
            this.animQueue[index] = this.animFactory(
              x.template,
    ...
    for (let [mt, x] of Object.entries(o)) {
      switch (mt) {
        ...
        case "moveto": {
          for (const e of Object.entries(x.props)) {
            if (e[1]) {
   ...
   */
  resetLips() {
    for (const x of this.visemeNames) {
      for (const y of this.morphs) {
  ...
  speakText(s, opt = null, onsubtitles = null, excludes = null) {
    ...
    for (let index = 0; index < letters.length; index++) {
      ...
      const isSpeakable = letters[index].match(speakables);
      const isEndOfSentence = letters[index].match(dividersSentence);
      const isEndOfWord = letters[index].match(dividersWord);

      // Add letter to subtitles
      if (onsubtitles) {
        markdownWord += letters[index];
      }

      // Add letter to spoken word
      if (
        isSpeakable &&
        (!excludes || excludes.every((x) => index < x[0] || index > x[1]))
      ) {
        textWord += letters[index];
      }
      ...
      if (isEndOfWord || isEndOfSentence || isLast) {
        ...
        if (textWord.length > 0) {
          ...
          if (v && v.visemes && v.visemes.length > 0) {
            const d =
              v.times[v.visemes.length - 1] + v.durations[v.visemes.length - 1];
            for (let index_ = 0; index_ < v.visemes.length; index_++) {
              const o = lipsyncAnim.push({
                mark: markId,
                template: { name: "viseme" },
                ts: [
                  (v.times[index_] - 0.6) / d,
                  (v.times[index_] + 0.5) / d,
                  (v.times[index_] + v.durations[index_] + 0.5) / d,
                ],
                vs: {
                  ["viseme_" + v.visemes[index_]]: [
                    null,
                    v.visemes[index_] === "PP" || v.visemes[index_] === "FF"
                      ? 0.9
                      : 0.6,
                    0,
                  ],
      ...
      if (isEndOfSentence || isLast) {
        ...
        if (ttsSentence.length > 0 || (isLast && lipsyncAnim.length > 0)) {
          const o = {
            anim: lipsyncAnim,
          };
          if (onsubtitles) o.onSubtitles = onsubtitles;
          if (ttsSentence.length > 0 && !opt.avatarMute) {
            o.text = ttsSentence;
        ...
        if (letters[index].match(emojis)) {
          let emoji = this.animEmojis[letters[index]];
  ...
  speakAudio(r, opt = null, onsubtitles = null) {
    ...
    if (r.words) {
      let lipsyncAnim = [];
      for (let index = 0; index < r.words.length; index++) {
        const word = r.words[index];
        const time = r.wtimes[index];
        let duration = r.wdurations[index];
        ...
        if (word.length > 0) {
          ...
          if (!r.visemes) {
            ...
            if (v && v.visemes && v.visemes.length > 0) {
              ...
              if (dTotal > 0) {
                for (let index = 0; index < v.visemes.length; index++) {
                  const t = time + (v.times[index] / dTotal) * duration;
                  const d = (v.durations[index] / dTotal) * duration;
                  lipsyncAnim.push({
                    template: { name: "viseme" },
                    ts: [
                      t - Math.min(60, (2 * d) / 3),
                    ...
                    vs: {
                      ["viseme_" + v.visemes[index]]: [
                        null,
                        v.visemes[index] === "PP" || v.visemes[index] === "FF"
                          ? 0.9
                          : level,
                        0,
                      ],
      ...
      if (r.visemes) {
        for (let index = 0; index < r.visemes.length; index++) {
          const viseme = r.visemes[index];
          const time = r.vtimes[index];
          const duration = r.vdurations[index];
          lipsyncAnim.push({
            template: { name: "viseme" },
            ts: [
              time - (2 * duration) / 3,
      ...
      if (r.markers) {
        for (let index = 0; index < r.markers.length; index++) {
          const function_ = r.markers[index];
          const time = r.mtimes[index];
          lipsyncAnim.push({
            template: { name: "markers" },
            ts: [time],
            vs: { "function": [function_] },
          });
        }
      }

      if (lipsyncAnim.length > 0) {
        o.anim = lipsyncAnim;
      }
    }
    ...
    if (Object.keys(o).length > 0) {
      this.speechQueue.push(o, { break: 300 });
      this.startSpeaking();
    }
  }
  ...
  async playAudio(force = false) {
    ...
    if (this.audioPlaylist.length > 0) {
      ...
      const delay = 100;
      if (item.anim) {
        for (const x of item.anim) {
          for (let index = 0; index < x.ts.length; index++) {
            x.ts[index] = this.animClock + x.ts[index] + delay;
          }
    ...
    if (this.speechQueue.length > 0) {
      ...
      if (line.emoji) {
        ...
        try {
          ...
          let ssml = "<speak>";
          for (const [index, x] of line.text.entries()) {
            // Add mark
            if (index > 0) {
          ...
          if (res.status === 200 && data && data.audioContent) {
            ...
            for (const [index, x] of data.timepoints.entries()) {
              const time = x.timeSeconds * 1000;
              let previousDuration = time - timepoints[index].time;
              if (previousDuration > 150) previousDuration - 150; // Trim out leading space
              timepoints[index].duration = previousDuration;
              timepoints.push({
                mark: Number.parseInt(x.markName),
                time: time,
              });
            }
            let d = 1000 * audio.duration; // Duration in ms
            if (d > this.opt.ttsTrimEnd) d = d - this.opt.ttsTrimEnd; // Trim out silence at the end
            timepoints.at(-1).duration = d - timepoints.at(-1).time;

            // Re-set animation starting times and rescale durations
            for (const x of line.anim) {
              const timepoint = timepoints[x.mark];
              if (timepoint) {
                for (let index = 0; index < x.ts.length; index++) {
                  x.ts[index] =
                    timepoint.time +
                    x.ts[index] * timepoint.duration +
        ...
        this.resetLips();
        if (line.mood) this.setMood(line.mood);
        for (const [index, x] of line.anim.entries()) {
          for (let index_ = 0; index_ < x.ts.length; index_++) {
            x.ts[index_] = this.animClock + 10 * index;
          }
          this.animQueue.push(x);
        }
  ...
  speakWithHands(delay = 0, prob = 0.5) {
    ...
    for (const x of ["LeftArm", "LeftForeArm", "RightArm", "RightForeArm"]) {
  ...
  async playAnimation(url, onprogress = null, dur = 10, ndx = 0, scale = 0.01) {
    ...
    if (item) {
      ...
      // Set new pose
      for (const x of Object.entries(item.pose.props)) {
      ...
      if (fbx && fbx.animations && fbx.animations[ndx]) {
          ...
          switch (ids[1]) {
            case "position": {
              for (let index = 0; index < t.values.length; index++) {
                t.values[index] = t.values[index] * scale;
              }
              properties[t.name] = new THREE.Vector3(
                t.values[0],
                t.values[1],
                t.values[2],
              );
            ...
            case "quaternion": {
              properties[t.name] = new THREE.Quaternion(
                t.values[0],
                t.values[1],
                t.values[2],
                t.values[3],
            ...
            case "rotation": {
              properties[ids[0] + ".quaternion"] = new THREE.Quaternion()
                .setFromEuler(
        ...
        // Add to clips
        const newPose = { props: properties };
        if (properties["Hips.position"]) {
          if (properties["Hips.position"].y < 0.5) {
            newPose.lying = true;
          } else {
        ...
        const message = "Animation " + url + " (ndx=" + ndx + ") not found";
  ...
  async playPose(url, onprogress = null, dur = 5, ndx = 0, scale = 0.01) {
    ...
    if (pose) {
      ...
      if (fbx && fbx.animations && fbx.animations[ndx]) {
        ...
        const message = "Pose " + url + " (ndx=" + ndx + ") not found";
        console.error(message);
      }
    }
  }
  ...
  ikSolve(ik, target = null, relative = false, d = null) {
    ...
    if (target) {
      for (let index = 0; index < iterations; index++) {
        let rotated = false;
        for (let index = 0, jl = links.length; index < jl; index++) {
          const bone = links[index].bone;
          ...
          if (
            links[index].minAngle !== undefined &&
            angle < links[index].minAngle
          ) {
            angle = links[index].minAngle;
          }
          if (
            links[index].maxAngle !== undefined &&
            angle > links[index].maxAngle
          ) {
            angle = links[index].maxAngle;
          }
          ...
          bone.rotation.setFromVector3(
            vector
              ...
              .clamp(
                new THREE.Vector3(
                  links[index].minx === undefined
                    ? -Infinity
                    : links[index].minx,
                  links[index].miny === undefined
                    ? -Infinity
                    : links[index].miny,
                  links[index].minz === undefined
                    ? -Infinity
                    : links[index].minz,
                ),
                new THREE.Vector3(
                  links[index].maxx === undefined
                    ? Infinity
                    : links[index].maxx,
                  links[index].maxy === undefined
                    ? Infinity
                    : links[index].maxy,
                  links[index].maxz === undefined
                    ? Infinity
                    : links[index].maxz,
                ),
              ),
